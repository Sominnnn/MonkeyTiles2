...
public class pause1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pause1);
        ...
        Button continueButton = findViewById(R.id.returnbtn_pause1);
        ...
        Button restartButton = findViewById(R.id.restartbtn_pause1);
        if (restartButton != null) {
            restartButton.setOnClickListener(v -> {
                // Create a new intent for hardnew activity with a restart flag
                Intent intent = new Intent(pause1.this, hardnew.class);
        ...
        Button homeButton = findViewById(R.id.homebtn_pause1);
        if (homeButton != null) {
            homeButton.setOnClickListener(v -> {
                Intent intent = new Intent(pause1.this, MainActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP); // Clear the activity stack
                startActivity(intent);
                finish(); // Close the pause activity
            });
